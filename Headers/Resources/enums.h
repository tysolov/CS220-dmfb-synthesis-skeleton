...
// Synthesis types
enum SchedulerType { LIST_S, PATH_S, GENET_S, RICKETT_S, FD_LIST_S, FPPC_S, FPPC_PATH_S, RT_EVAL_LIST_S, GENET_PATH_S, ROUTING_BASED_SYNTHESIS_S, CS220_S /*,NEW_S*/};
enum PlacerType { GRISSOM_LE_B, GRISSOM_PATH_B, KAMER_LL_P, FPPC_LE_B, ROUTING_BASED_SYNTHESIS_P, NSGAII_P, CS220_P /*,NEW_P*/}; // Placer OR Binder
enum RouterType { GRISSOM_FIX_R, GRISSOM_FIX_MAP_R, ROY_MAZE_R, BIOROUTE_R, FPPC_SEQUENTIAL_R, FPPC_PARALLEL_R, CHO_R, LEE_R, ROUTING_BASED_SYNTHESIS_R, CDMA_FULL_R, CS220_R /*,NEW_R*/};
