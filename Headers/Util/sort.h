...
class Sort
{
	public:
		...
		static void sortNodesByStartTS(vector<AssayNode *> *v);
		static void sortNodesByStartTSThenStorageFirst(list<AssayNode *> *l);
		static void sortNodesByStartTSThenStorageFirst(vector<AssayNode *> *v);
		static void sortNodesByPriorityHiFirst(list<AssayNode *> *l);
        static void sortNodesByPriorityHiFirst(vector<AssayNode *> *v);
        ...
        static void sortNodesByLimitedResources(vector<AssayNode *> *v);
        ...
        static void sortNodesByLatestTSAndStorage(vector<AssayNode *> *v);
		...
		static void sortConditionsByOrder(vector<Condition*>* v);
