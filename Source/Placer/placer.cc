...
void Placer::getAvailResources(DmfbArch *arch)
{
	...
	for (int i = 0; i <= RES_TYPE_MAX; i++)
	{
		availRes[i].clear(); // Clear in case re-using placer
...
///////////////////////////////////////////////////////////////////////////////////
// Binds the given transfer-in nodes by simply changing their status.
///////////////////////////////////////////////////////////////////////////////////
void Placer::bindTransferIns(list<AssayNode *> *transferInNodes)
{
	list<AssayNode *>::iterator it = transferInNodes->begin();
	for (; it != transferInNodes->end(); it++)
	{
		AssayNode *n = *it;
		n->status = BOUND;
...
///////////////////////////////////////////////////////////////////////////////////
// Binds the given transfer-out nodes by simply changing their status.
///////////////////////////////////////////////////////////////////////////////////
void Placer::bindTransferOuts(list<AssayNode *> *transferOutNodes)
{
	list<AssayNode *>::iterator it = transferOutNodes->begin();
	for (; it != transferOutNodes->end(); it++)
	{
		AssayNode *n = *it;
		n->status = BOUND;
		n->boundedResType = UNKNOWN_RES;
...
///////////////////////////////////////////////////////////////////////////////////
// Checks if the chosen placer is capable of performing global optimizations via
//  the discovered coalesced operations
///////////////////////////////////////////////////////////////////////////////////
bool Placer::isGlobalPlacer()
{
	// search for "GLOBAL" in comments to get an idea of changes needed to make an
	// existing placer capable of performing global placement.
	switch (this->type)
	{
		case GRISSOM_LE_B:
			return true;
