...
CmdLine::CmdLine()
{
	...
	sKeys.push_back("CSS"); sDescrips.push_back("Calvin & Skyler's Routing Based Synthesis Scheduler"); sEnums.push_back(ROUTING_BASED_SYNTHESIS_S);
	sKeys.push_back("CS220S"); sDescrips.push_back("CS220 Scheduler"); sEnums.push_back(CS220_S);
	...
	pKeys.push_back("CSP"); pDescrips.push_back("Calvin & Skyler's Routing Based Synthesis Placer"); pEnums.push_back(ROUTING_BASED_SYNTHESIS_P);
	pKeys.push_back("NSGAII"); pDescrips.push_back("NSGAII Genetic Algorithm Placer"); pEnums.push_back(NSGAII_P);
	pKeys.push_back("CS220P"); pDescrips.push_back("CS220 Placer"); pEnums.push_back(CS220_P);
	...
	rKeys.push_back("CSR"); rDescrips.push_back("Calvin & Skyler's Routing Based Synthesis Router"); rEnums.push_back(ROUTING_BASED_SYNTHESIS_R);
	rKeys.push_back("CS220R"); rDescrips.push_back("CS220 Router"); rEnums.push_back(CS220_R);
